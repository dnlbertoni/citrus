<div class="modal-dialog">
  <div class="modal-content">
    ...
    <div class="modal-footer">
      ...
      <button type="reset" class="btn btn-warning"><span class="fa fa-refresh fa-fw"></span>&nbsp;Limpiar Formulario
      </button>
      <button type="submit" class="btn btn-success"><span class="fa fa-plus-circle fa-fw"></span>&nbsp;Guardar</button>
    </div>
    <?php echo form_close () ?>
  </div>
  <!-- /.modal-content -->
