...
$(document).ready(function(){
  ...
  //$("#F8").button();
  $("#F8").click(function(){CambioCondicion('agrego');});
  //$("#F10").button();
  $("#F10").click(function(){CambioComprobante();});
  //$("#F12").button();
...
function CambioComprobante(){
  ...
  url = <?php echo $paginaCambioComprob;?>;
...
=======
  ...
  $.ajax({
    ...
    global: true,
    type: "POST",
    data: ({ tmpfacencab: tmpfacencab_id
    }),
    dataType: "json",
    async:true,
