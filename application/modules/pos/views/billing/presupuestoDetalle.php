    ...
    <div class="text-center"> <!-- fila de comprobante -->
      ...
      <div class="col-lg-2 col-md-2">
        <div class="panel panel-success">
          ...
          <div class="panel-body">
            <table class="table">
              <tr><td id="idCuenta"><?php echo $presuEncab->cuenta_id?></td></tr>
              <tr><td id="nombreCuenta"><?php echo $presuEncab->cuenta_nombre?></td></tr>
            </table>
          </div>
        </div>
      </div>
      ...
      <div class="col-lg-4 col-md-4">
        <div class="panel panel-warning">
          ...
          <div class=" panel-body">
            <ul class=" list-group">
              <li class=" list-group-item text-danger" style="font-size:56px;"><?php printf("$%01.2f", floatval($totales->Total));?></li>
            </ul>
          </div>
