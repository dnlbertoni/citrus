...
<div class="container">
    <div class="row">
      <div class="col-lg-4 col-md-4">
        <h3><i class="fa fa-check-circle"></i>Operciones Diarias</h3>
        <table>
            <tr>
                <td><button type="button" class="btn btn-danger">Inicio de Caja</button></td>
                <td>&nbsp;</td>
                <td>hora de cierre</td>
            </tr>
            <tr><td colspan="3">&nbsp;</td></tr>
            <tr>
                <td><button type="button" class="btn btn-info">Planilla de Caja</button></td>
                <td>&nbsp;</td>
                <td>hora de cierre</td>
            </tr>        
            <tr><td colspan="3">&nbsp;</td></tr>
            <tr>
                <td><button type="button" class="btn btn-success">Cierre de Caja</button></td>
                <td>&nbsp;</td>
                <td>hora de cierre</td>
            </tr>   
        </table>                
      ...
      <div class="col-lg-4 col-md-4">
        <h3><i class="fa fa-pencil"></i>Informes</h3>
