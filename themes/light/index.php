...
<!--[if gt IE 8]><!--> <html class="no-js" lang="en"> <!--<![endif]-->
	...
	<head>
		...
		<link rel="stylesheet" href="<?php echo base_url(); ?>themes/light/css/style.css">
		<link rel="stylesheet" href="<?php echo base_url(); ?>themes/light/css/jquery-ui.css">
		<script src="<?php echo base_url(); ?>themes/light/js/libs/modernizr-2.0.6.js"></script>
		<script src="<?php echo base_url(); ?>themes/light/js/libs/jquery.js"></script>
        <script src="<?php echo base_url(); ?>themes/light/js/libs/jquery-ui.js"></script>
        <script src="<?php echo base_url(); ?>themes/light/js/libs/bootstrap.min.js"></script>
		...
		<script defer src="<?php echo base_url(); ?>themes/light/js/plugins.js"></script>
		<script defer src="<?php echo base_url(); ?>themes/light/js/script.js"></script>
		<script src="<?php echo base_url(); ?>themes/light/js/bootstrap-datepicker.js"></script>

		<!--[if lt IE 7 ]>
			<script src="<?php echo base_url(); ?>themes/light/js/dd_belatedpng.js"></script>
